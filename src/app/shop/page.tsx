            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-8">
                ...
                <div className="lg:col-span-1 space-y-6 md:space-y-8 sticky top-24 h-fit">
                    ...
                    <div className="hidden lg:block p-6 rounded-3xl bg-linear-to-br from-primary to-secondary text-white relative overflow-hidden group">
                        ...
                        <Button variant="secondary" className="w-full rounded-lg h-10 font-black relative">Get Coupon</Button>
                    </div>
                </div>
                ...
                <div className="lg:col-span-3">
                    {loading ? (
                        <div className="h-96 flex flex-col items-center justify-center gap-3">
                            ...
                            <p className="font-black text-sm text-muted-foreground uppercase tracking-widest">Loading Products...</p>
                        </div>
